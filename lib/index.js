...
function normalizePaths (value) {
  ...
  const workspaceRootReal = getRealPath(workspaceRoot)
  ...
  const runner = [
    ...
    // Replace yarn workspace root with <WORKSPACE_ROOT>
    val => val.split(workspaceRoot).join('<WORKSPACE_ROOT>'),
    val => val.split(workspaceRootReal).join('<WORKSPACE_ROOT>'),
